...
create table user_subscription (subscription_type tinyint check (subscription_type between 0 and 0), expires timestamp(6), start timestamp(6), subscription_id uuid not null, primary key (subscription_id));
